...
export default function AdminDashboard() {
  ...
  const stats = [
    { name: 'Total Users', value: '12,847', icon: Users, color: 'bg-blue-500', change: '+12% this month', trend: 'up' },
    { name: 'Active Courses', value: '1,284', icon: BookOpen, color: 'bg-green-500', change: '+8% this month', trend: 'up' },
    { name: 'Monthly Revenue', value: '$89,432', icon: DollarSign, color: 'bg-yellow-500', change: '+15% this month', trend: 'up' },
    { name: 'System Health', value: '99.9%', icon: Activity, color: 'bg-purple-500', change: 'All systems operational', trend: 'stable' },
    { name: 'Active Students', value: '10,245', icon: UserCheck, color: 'bg-indigo-500', change: '+156 today', trend: 'up' },
    { name: 'Active Teachers', value: '2,456', icon: Award, color: 'bg-pink-500', change: '+23 this week', trend: 'up' },
    { name: 'Course Completion', value: '78.5%', icon: Target, color: 'bg-emerald-500', change: '+2.3% this month', trend: 'up' },
    { name: 'Support Tickets', value: '47', icon: AlertTriangle, color: 'bg-red-500', change: '-12 resolved today', trend: 'down' },
  ];
